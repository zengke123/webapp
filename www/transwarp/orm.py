...
class Field(object):
    ...
    def __str__(self):
        ...
        self.nullable and s.append('N')    # if...else
...
class StringField(Field):
    ...
    def __init__(self,**kw):
        ...
        if not 'ddl' in kw:
            kw['ddl'] = 'varchar(255)'
        super(StringField,self).__init__(**kw)   # Field.__init__(**kw)
...
class IntegerField(Field):
    ...
    def __init__(self, **kw):
        ...
        if not 'ddl' in kw:
            kw['ddl'] = 'bigint'
        super(IntegerField, self).__init__(**kw)  # Field.__init__(**kw)
...
def _gen_sql(table_name,mappings):
    ...
    for f in sorted(mappings.values(),cmp=lambda x,y :cmp(x._order, y._order)):
